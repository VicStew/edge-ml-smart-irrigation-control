...
nb["cells"] = [
    nbf.v4.new_markdown_cell(
        ...
        "This notebook trains and evaluates the dedicated hourly rainfall model from "
        ...
        "Historical weather columns are stored for auditing, but the deployed model only uses date, month, and time at inference."
    ),
    ...
    nbf.v4.new_markdown_cell("## 4. Time-Based Split"),
    nbf.v4.new_code_cell(
    ...
    nbf.v4.new_markdown_cell("## 6. Train And Evaluate"),
    nbf.v4.new_code_cell(
    ...
    nbf.v4.new_markdown_cell("## 7. Export Artifact"),
    nbf.v4.new_code_cell(
        "artifact = {\n"
